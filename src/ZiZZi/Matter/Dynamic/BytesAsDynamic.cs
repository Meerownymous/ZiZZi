...
namespace ZiZZi.Matter.Dynamic
{
    ...
    {
        private readonly SwapSwitch<string, byte[], object> swap;
        ...
        public BytesAsTyped()
        {
            this.swap =
                SwapSwitch._(
                    Lambda._(
                        () => Debug.WriteLine("BytesAsTyped enumeration"),
                        AsEnumerable._(
        ...
        public object Flip(string contentType, string name, byte[] input) =>
