...
var project = new DirectoryPath("./src/BriX/BriX.csproj");
  ...
  .Does(() =>
{
	...
	//var projectFiles = GetFiles("./tests/BriX.Tests/bin/Debug/netcoreapp2.0/*.tests.dll");
...
.Does(() => 
{
	try
	{
		OpenCover(
			tool => 
			{
				tool.DotNetCoreTest("./tests/Test.BriX/",
